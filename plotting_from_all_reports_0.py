...
def plot_s_graphics(pd_df, param, x_axis, y_axis, plot_type, out_dir, separator, sep2):
    ...
    for par in pd_df[param].unique():
        ...
        # plot_.fig.suptitle(f'{pd_df["Description"]}')
...
def main(all_rep_dir, metadata_dir, param, x_axis, y_axis, plot_type, separator, sep2):
    """
    INSTRUCTIONS:
    ...
    plot_s_graphics(df1, param, x_axis, y_axis, plot_type, all_rep_dir, separator, sep2)
...
main(all_rep_dir, metadata_dir, param, x_axis, y_axis, plot_type, separator, sep2)
