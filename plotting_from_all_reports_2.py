    ...
    for par in pd_df[param].unique():
        ...
        if save_or=="y":
            ...
            if plot_save_format=="html":
                ...
                plot_.savefig(f"{param}-{par}.{plot_save_format}", dpi=dpi_qual)
...
def main():
    ...
    plot_s_graphics(df1, param, x_axis, y_axis, plot_type, separator, save_or, save_dir, dpi_qual, plot_save_format)
